...
export type PackageConfig = TsconfigJson & {
  /**
   * If this specific configuration should be merged with the
   * defaults. Obviously, prevails over defaults.
   *
   * @default false
   */
  merge?: boolean;
  ...
  /**
   * If we shouldn't make a request and verify if the package has and
   * @types/package npm module available.
   *
   * @default false
   */
